...
pub fn build(b: *std.build.Builder) void {
    ...
    exe.addCSourceFile("src/backends/windows/backend.c", &.{""});
    exe.addCSourceFile("src/backends/windows/lag_engine.c", &.{""});
    exe.addCSourceFile("src/backends/windows/legacy/bandwidth.c", &.{""});
    exe.addCSourceFile("src/backends/windows/legacy/divert.c", &.{""});
    exe.addCSourceFile("src/backends/windows/legacy/drop.c", &.{""});
    exe.addCSourceFile("src/backends/windows/legacy/duplicate.c", &.{""});
    exe.addCSourceFile("src/platform/windows/elevate.c", &.{""});
    exe.addCSourceFile("src/backends/windows/legacy/ood.c", &.{""});
    exe.addCSourceFile("src/backends/windows/legacy/packet.c", &.{""});
    exe.addCSourceFile("src/backends/windows/legacy/reset.c", &.{""});
    exe.addCSourceFile("src/backends/windows/legacy/tamper.c", &.{""});
    exe.addCSourceFile("src/backends/windows/legacy/throttle.c", &.{""});
    ...
    exe.addIncludeDir("src/backends/windows/legacy");
